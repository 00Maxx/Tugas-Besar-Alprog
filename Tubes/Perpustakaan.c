...
/*Fungsi header pada program ynag digunakan sebagai judul*/
void header (){ 
	...
	printf ("\t\t=======================================\n");
	printf ("\t\tcreated by : Max \n\t\t\t     Firman Karunia Naibaho \n");
...
void pinjam()
{
	...
	scanf("%s", &npm);
	printf("Tanggal Peminjaman (contoh: 9 desember 2022 ditulis 09 12 2022): \n"); 
